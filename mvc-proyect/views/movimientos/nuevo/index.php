        ...
        <div class="container">
            ...
            <form action="<?= URL ?>movimientos/create" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <?= (isset($this->errores['fecha_hora'])) ? 'is-invalid' : null ?>" name="fecha_hora" id="fecha_hora" value="<?php echo date('Y-m-d\TH:i:s'); ?>">
                ...
                <div class="mb-3">
                    ...
                    <?= (isset($this->errores['concepto'])) ? 'is-invalid' : null ?>" name="concepto" id="concepto" value="<?= $this->movimiento->concepto ?>">
                ...
                <div class="mb-3">
                    ...
                    <?= (isset($this->errores['cantidad'])) ? 'is-invalid' : null ?>" name="cantidad" id="cantidad" value="<?= $this->movimiento->cantidad ?>" step="0.01">
